...
|---|---|---|---|---|---|
| **mcharness** (este repo) | `make test` | ✅ **exit 0** · 28 suites, 0 failed | 2026-09-02 | 118-179 s | **Alta.** Determinista, sin red, sin LLM. Es el oráculo de referencia del harness. |
